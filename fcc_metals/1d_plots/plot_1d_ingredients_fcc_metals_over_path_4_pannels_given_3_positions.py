...
#    ax_left.axvspan(x4[0], x4[1], color=color_base, alpha=0.20, zorder=0)
    ...
    ax_1.plot(y, ratio_pbe, color="tab:blue",   lw=lwidth, ls="-", label="PBE")
    ax_1.plot(y, ratio_scan, color="tab:orange", lw=lwidth, ls="-", label="SCAN")
    ax_1.plot(y, ratio_r2scan, color="tab:green",  lw=lwidth, ls="-", label="r2SCAN")
    ax_1.plot(y, ratio_lak, color="tab:cyan",   lw=lwidth, ls="-", label="LAK")
    ax_1.plot(y, ratio_lda, color="tab:purple", lw=lwidth, ls="-", label="LDA")
    
    ax_1.axhline(0.0, color="k", lw=0.8, ls="--")
    ax_1.set_ylabel(r"$R_{xc}$", fontsize=24)
