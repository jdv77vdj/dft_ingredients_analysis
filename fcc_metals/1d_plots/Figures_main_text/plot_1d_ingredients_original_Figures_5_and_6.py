...
### Script for plotting the main Figures 5 and 6 given the ingredients generated by the script: ingredients_generator_1d_original.py
...
### Outputs: 2 grid plots: main_metals.pdf, having Al, Ni, Pd, Pt; and supplement_metals.pdf having Cu, Ag, Au and Pb
...
def plot_metal(metal_name, limits, ax_left, ax_mid, ax_right):
    ...
    ax_left.set_ylim(-0.030, 0.04)
    ax_left.set_xlim(0.1,1.75)
   ...
   ############################################
    ...
    ax_mid.plot(x, 3*ds,  color='tab:blue',  lw=lwidth, label=r"$3\Delta s$")
    ax_mid.plot(x, da,  color='tab:green', lw=lwidth, label=r"$\Delta \alpha$")
    ax_mid.plot(x, drs, color='tab:red',   lw=lwidth, label=r"$\Delta r_s$")
