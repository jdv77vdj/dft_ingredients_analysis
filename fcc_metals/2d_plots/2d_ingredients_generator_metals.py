...
systems = dict() ### generate an empty dictionary
  # koff is the offset required to plot a binding region path that includes the vacancy, since the vacancy is at different positions for different systems.
  # LCs in Angstrom, but twice the  (important for calculating the gradient!)

### Each metal is stored in the systems dictionary.
