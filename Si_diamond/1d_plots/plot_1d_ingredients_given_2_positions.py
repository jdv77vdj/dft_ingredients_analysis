...
def plot_defect(metal_name, defect_name, limits):
    ...
    base_path = f"/Users/jdv/Desktop/Tulane/Tulane-Research/Projects/Defects_SCAN/fcc_metals_vac_formation_energy/updated_ingredients_May19_silicon_only"
    file_pr = f"{base_path}/{metal_name}/t2_1d_data_path_ae.dat"
    file_def = f"{base_path}/{defect_name}/t2_1d_data_path_ae.dat"
...
#    ax_right.set_xlim(*xlim_right)
    ...
    plt.savefig(f"t2_3_pan_{metal_name}_{defect_name}.pdf", dpi=300, bbox_inches="tight")
    #plt.show()
